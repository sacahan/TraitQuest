...
talents = [
    ...
    (
        ...
        "成就",
        "talent",
        {"domain": "Executing", "original": "Achiever", "icon": "flag"},
    ),
    (
        "TAL_ARR",
        "排定",
        "talent",
        {"domain": "Executing", "original": "Arranger", "icon": "tune"},
    ),
    (
        "TAL_BEL",
        "信仰",
        "talent",
        {"domain": "Executing", "original": "Belief", "icon": "verified"},
    ),
    (
        "TAL_CON",
        "公平",
        "talent",
        {"domain": "Executing", "original": "Consistency", "icon": "balance"},
    ),
    (
        "TAL_DEL",
        "謹慎",
        "talent",
        {"domain": "Executing", "original": "Deliberative", "icon": "shield"},
    ),
    (
        "TAL_DIS",
        "紀律",
        "talent",
        {"domain": "Executing", "original": "Discipline", "icon": "rule"},
    ),
    (
        "TAL_FOC",
        "專注",
        "talent",
        {"domain": "Executing", "original": "Focus", "icon": "center_focus_strong"},
    ),
    (
        "TAL_RES",
        "責任",
        "talent",
        {"domain": "Executing", "original": "Responsibility", "icon": "task_alt"},
    ),
    (
        "TAL_RSV",
        "修復",
        "talent",
        {"domain": "Executing", "original": "Restorative", "icon": "healing"},
    ),
    # Influencing
    (
        "TAL_ACT",
        "激活",
        "talent",
        {"domain": "Influencing", "original": "Activator", "icon": "bolt"},
    ),
    (
        "TAL_COM",
        "統率",
        "talent",
        {"domain": "Influencing", "original": "Command", "icon": "campaign"},
    ),
    (
        "TAL_CMU",
        "溝通",
        "talent",
        {"domain": "Influencing", "original": "Communication", "icon": "chat"},
    ),
    (
        "TAL_CPT",
        "競爭",
        "talent",
        {"domain": "Influencing", "original": "Competition", "icon": "emoji_events"},
    ),
    (
        "TAL_MAX",
        "完美",
        "talent",
        {"domain": "Influencing", "original": "Maximizer", "icon": "diamond"},
    ),
    (
        "TAL_SAD",
        "自信",
    ...
    (
        ...
        "追求",
        "talent",
        {"domain": "Influencing", "original": "Significance", "icon": "star"},
    ),
    (
        "TAL_WOO",
        "取悅",
        "talent",
        {"domain": "Influencing", "original": "Woo", "icon": "group_add"},
    ),
    # Relationship
    (
        "TAL_ADP",
    ...
    (
        ...
        "關聯",
        "talent",
        {"domain": "Relationship Building", "original": "Connectedness", "icon": "hub"},
    ),
    (
        "TAL_DEV",
        "發展",
        "talent",
        {"domain": "Relationship Building", "original": "Developer", "icon": "sprout"},
    ),
    (
        "TAL_EMP",
        "共感",
        "talent",
        {"domain": "Relationship Building", "original": "Empathy", "icon": "favorite"},
    ),
    (
        "TAL_HAR",
        "和諧",
        "talent",
        {"domain": "Relationship Building", "original": "Harmony", "icon": "handshake"},
    ),
    (
        "TAL_INC",
        "包容",
    ...
    (
        ...
        "積極",
        "talent",
        {"domain": "Relationship Building", "original": "Positivity", "icon": "sunny"},
    ),
    (
        "TAL_REL",
        "交往",
    ...
    (
        ...
        "分析",
        "talent",
        {"domain": "Strategic Thinking", "original": "Analytical", "icon": "analytics"},
    ),
    (
        "TAL_CTX",
        "回顧",
        "talent",
        {"domain": "Strategic Thinking", "original": "Context", "icon": "history"},
    ),
    (
        "TAL_FUT",
        "前瞻",
    ...
    (
        ...
        "理念",
        "talent",
        {"domain": "Strategic Thinking", "original": "Ideation", "icon": "lightbulb"},
    ),
    (
        "TAL_INP",
        "蒐集",
        "talent",
        {"domain": "Strategic Thinking", "original": "Input", "icon": "inventory_2"},
    ),
    (
        "TAL_ITL",
        "思維",
    ...
    (
        ...
        "學習",
        "talent",
        {"domain": "Strategic Thinking", "original": "Learner", "icon": "school"},
    ),
    (
        "TAL_STR",
        "戰略",
        "talent",
        {"domain": "Strategic Thinking", "original": "Strategic", "icon": "route"},
    ),
]
