      ...
      <section className="py-20 px-4 md:px-10 bg-[#0d1a12] relative overflow-hidden w-full">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {renderRaceCard('1號：完美主義者', '鐵律之魂', '追求秩序與完美的靈魂，源自遠古法典之山。')}
            {renderRaceCard('2號：給予者', '聖靈之魂', '渴望被愛與付出的靈魂，源自生命之泉。')}
            {renderRaceCard('3號：成就者', '輝光之魂', '追求成就與注視的靈魂，源自永恆烈陽。')}
            {renderRaceCard('4號：浪漫者', '幻影之魂', '沉浸於獨特與憂傷的靈魂，源自迷霧森林。')}
            {renderRaceCard('5號：觀察者', '智者之魂', '渴求知識與觀察的靈魂，源自星辰圖書館。')}
            {renderRaceCard('6號：懷疑論者', '堅盾之魂', '追求安全與忠誠的靈魂，源自地下堡壘。')}
            {renderRaceCard('7號：享樂主義者', '秘風之魂', '追求自由與新奇的靈魂，源自流浪之雲。')}
            {renderRaceCard('8號：挑戰者', '霸龍之魂', '追求力量與控制的靈魂，源自火山熔岩。')}
            {renderRaceCard('9號：和平締造者', '蒼翠之魂', '追求和平與融合的靈魂，源自萬物母林。')}
          </div>
        </div>
      </section>
...
function renderRaceCard(type: string, race: string, desc: string) {
