...
| -------- | -------------------- | -------- | -------- | ---------------------------------------- |
| `RACE_1` | 鐵律之魂 (Iron Law)    | 1 型     | 本能     | 追求秩序與完美的靈魂，源自遠古法典之山。 |
| `RACE_2` | 聖靈之魂 (Holy Spirit) | 2 型     | 情感     | 渴望被愛與付出的靈魂，源自生命之泉。     |
| `RACE_3` | 輝光之魂 (Radiant)     | 3 型     | 情感     | 追求成就與注視的靈魂，源自永恆烈陽。     |
| `RACE_4` | 幻影之魂 (Phantom)     | 4 型     | 情感     | 沉浸於獨特與憂傷的靈魂，源自迷霧森林。   |
| `RACE_5` | 智者之魂 (Sage)        | 5 型     | 精神     | 渴求知識與觀察的靈魂，源自星辰圖書館。   |
| `RACE_6` | 堅盾之魂 (Aegis)       | 6 型     | 精神     | 追求安全與忠誠的靈魂，源自地下堡壘。     |
| `RACE_7` | 秘風之魂 (Secret Wind) | 7 型     | 精神     | 追求自由與新奇的靈魂，源自流浪之雲。     |
| `RACE_8` | 霸龍之魂 (Overlord)    | 8 型     | 本能     | 追求力量與控制的靈魂，源自火山熔岩。     |
| `RACE_9` | 蒼翠之魂 (Verdant)     | 9 型     | 本能     | 追求和平與融合的靈魂，源自萬物母林。     |
