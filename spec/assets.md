...
| `CLS_INFJ` | 神聖牧師   | INFJ      | 外交使節 | 神秘、同理、堅定、理想。 |
| `CLS_INFP` | 吟遊詩人   | INFP      | 外交使節 | 溫柔、創意、忠於自我。   |
| `CLS_ENFJ` | 光明聖騎士 | ENFJ      | 外交使節 | 魅力、熱情、利他、組織。 |
| `CLS_ENFP` | 元素召喚師 | ENFP      | 外交使節 | 活力、想像、自由、熱誠。 |
...
| `CLS_ISTP` | 武器工匠   | ISTP      | 探險公會 | 靈活、觀察、技術、冷靜。 |
| `CLS_ISFP` | 森林遊俠   | ISFP      | 探險公會 | 感性、審美、冒險、低調。 |
| `CLS_ESTP` | 暗影刺客   | ESTP      | 探險公會 | 行動、大膽、理性、感知。 |
| `CLS_ESFP` | 幻術舞者   | ESFP      | 探險公會 | 娛樂、自發、社交、表演。 |
